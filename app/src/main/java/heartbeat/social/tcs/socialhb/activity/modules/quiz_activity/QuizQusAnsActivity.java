...
public class QuizQusAnsActivity extends AppCompatActivity {
    ...
    public void setFirstQuestionWithOptions(){
        ...
        for(QuizAnswer quizAnswer : quiz_questions_list.get(question_number).getQuizAnswer_list()){
            ...
            appCompatRadioButton.setTextColor(getResources().getColor(R.color.grey_color_1));
            appCompatRadioButton.setTextSize(13);
                ...
                public void onClick(View v) {
                    ...
                    if (i == 1) {
                        ...
                        new SweetAlertDialog(QuizQusAnsActivity.this, SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("Please select atleast one option")
                                .show();
                    }
                }
            });
    ...
    public void showSuccessMessage()
    {
        ...
        intent1.putExtra("score", String.valueOf(quizScore_response.getScore()));
        intent1.putExtra("area_of_interest", String.valueOf(quizScore_response.getArea_of_interest_cat_id()));
    ...
    public void quitFromQuiz()
    {
        ...
        quiz_quit_dialog.setConfirmText("Yes");
        quiz_quit_dialog.setCancelText("No");
