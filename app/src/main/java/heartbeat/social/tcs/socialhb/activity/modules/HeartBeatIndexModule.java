...
public class HeartBeatIndexModule extends AppCompatActivity {
    ...
    TextView txt_quiz_highest_score, txt_quiz_interest, txtPreviousScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPreviousScore       = (TextView) findViewById(R.id.txtPreviousScore);
    ...
    public void getQuiStartConfirmation(){
        ...
        quiz_start_confirmation_dialog.setConfirmText("Yes");
        quiz_start_confirmation_dialog.setCancelText("No");
        ...
        Log.e(TAG , String.valueOf(quiz_start_confirmation_dialog.getAlerType()));
    ...
    public void setData()
    {
        ...
        if(prev_quizScore.getId() != 0){
            txt_quiz_highest_score.setText(String.valueOf(prev_quizScore.getHighest_score()));
            txtPreviousScore.setText(String.valueOf(prev_quizScore.getScore()));
        ...
        if(prev_quizScore.getScore() == 0){
            txtPreviousScore.setText("NA");
        }
