...
import heartbeat.social.tcs.socialhb.activity.nav_drawer_activity.Contribution;
...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Social Heartbeat");
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch(id){
                    ...
                    case R.id.navigation_item_settings:
                        Intent setting_intent = new Intent(getApplicationContext(), Profile.class);
        ...
        drawer_layout_relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mDrawerLayout.closeDrawers();
                Intent intent1 = new Intent(getApplicationContext(), Contribution.class);
                startActivity(intent1);
            }
        });
