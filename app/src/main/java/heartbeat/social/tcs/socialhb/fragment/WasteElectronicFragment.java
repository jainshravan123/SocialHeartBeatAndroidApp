...
public class WasteElectronicFragment extends Fragment {
    ...
    public WasteElectronicFragment() {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_waste_electronic, container, false);
    ...
    private void getTipsData()
    {
        ...
        String url = Web_API_Config.tips_according_to_category+"6";
