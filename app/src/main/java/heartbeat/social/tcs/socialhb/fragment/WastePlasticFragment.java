...
public class WastePlasticFragment extends Fragment {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_waste_plastic, container, false);
    ...
    private void getTipsData()
    {
        ...
        String url = Web_API_Config.tips_according_to_category+"5";
