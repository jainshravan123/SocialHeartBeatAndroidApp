...
import static heartbeat.social.tcs.socialhb.R.id.linearLayout;
...
public class FactDescription extends AppCompatActivity {
    ...
    private TextView txtFact, txtFactCity, txtFactDescription, txt_fact_desc_purpose_for_life;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout4      = (LinearLayout) findViewById(R.id.linearLayoutFactPurposeForLife);
        ...
        txt_fact_desc_purpose_for_life = (TextView) findViewById(R.id.txt_fact_desc_purpose_for_life);
        ...
        getSupportActionBar().setTitle("Story Description");
        ...
        txt_fact_desc_purpose_for_life.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Web_API_Config.purpose_for_life));
