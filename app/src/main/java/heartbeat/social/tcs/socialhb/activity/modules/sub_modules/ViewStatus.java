...
public class ViewStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(getApplicationContext(), DonateItem.class);
    ...
    {
        Log.e(TAG, "_______________ Status Report _________________");
        for(SingleDonateItem singleDonateItem : donateItemArrayList){
            Log.e(TAG, String.valueOf(singleDonateItem.getId()));
            Log.e(TAG, String.valueOf(singleDonateItem.getNoOfItems()));
        }
        Log.e(TAG, "_______________ Status Report _________________");

        Collections.reverse(donateItemArrayList);
