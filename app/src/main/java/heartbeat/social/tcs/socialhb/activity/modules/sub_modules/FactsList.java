...
public class FactsList extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private CSRInit selected_aoi_obj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String selected_aoi  = intent1.getStringExtra("selected_aoi");
        Log.e("Selected City Here List", selected_city);
        city_obj = new City();
        selected_aoi_obj =  new CSRInit();

        city_obj.setId(Integer.parseInt(selected_city.trim()));
        selected_aoi_obj.setCsr_module_id(Integer.parseInt(selected_aoi.trim()));
        ...
        getSupportActionBar().setTitle("Inspiring Impacts");
    ...
    public void getAllFacts(){
        ...
        String uri = Web_API_Config.factsByCityIdAndCSRInitAPI + String.valueOf(city_obj.getId())+"/"+String.valueOf(selected_aoi_obj.getCsr_module_id());
