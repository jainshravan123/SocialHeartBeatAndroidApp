...
public class WasteMedicalFragment extends Fragment {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_waste_medical, container, false);
    ...
    private void getTipsData()
    {
        ...
        String url = Web_API_Config.tips_according_to_category+"8";
