...
public class GEOModule extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedAOI               = new CSRInit();
        citySelected              = new City();
        csrInitSelected           = new CSRInit();
        ...
        getSupportActionBar().setTitle("Mobile Geography");
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.putExtra("selected_city", String.valueOf(citySelected.getId()));
                intent1.putExtra("selected_aoi", String.valueOf(csrInitSelected.getCsr_module_id()));
                    ...
                    public void onResponse(JSONArray response)
                    {
                            for(int i=0; i<response.length(); i++){
                                ...
                                try {
                                    ...
                                    if(csrInit.getCsr_module_id() == 1 || csrInit.getCsr_module_id() == 2){
                                        csrInitCategories.add(csrInit);
                                    }
...
*/
    ...
    public void selectdData(final ArrayList<City> cities_data){
       ...
       spinner_area_of_interest.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
           @Override
           public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               Log.e(TAG, "SELECTED AOI 1       : " + spinner_area_of_interest.getSelectedItem().toString());
               Log.e(TAG, "SELECTED AOI 2       : " + csrInitCategories.get(position).getCsr_module_name().toString());
               selectedAOI.setCsr_module_id(csrInitCategories.get(position).getCsr_module_id());
               selectedAOI.setCsr_module_name(csrInitCategories.get(position).getCsr_module_name());
               csrInitSelected.setCsr_module_id(csrInitCategories.get(position).getCsr_module_id());
           }
        ...
        spinner_city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.e(TAG, "SELECTED AOI 3       : "+String.valueOf(selectedAOI.getCsr_module_id()));
                Log.e(TAG, "SELECTED AOI 4       : "+String.valueOf(selectedAOI.getCsr_module_name()));

                citySelected.setId(cities_data.get(position).getId());


               /* if (flag > 0) {
                    Intent intent1 = new Intent(getApplicationContext(), FactsList.class);
                    intent1.putExtra("selected_city", String.valueOf(cities_data.get(position).getId()));
                    intent1.putExtra("selected_aoi", String.valueOf(selectedAOI.getCsr_module_id()));
                    //intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent1);
                }
   ...
   /* @Override
    ...
    public void getPreviousScoreDetails() throws JSONException
    {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(prev_quizScore.getId() != 0){
                                ...
                                prev_quizScore.setHighest_score(response.getInt("highest_score"));
